package com.lld.problems.B_Elevator.controller;

import com.lld.problems.B_Elevator.entities.Direction;
import com.lld.problems.B_Elevator.entities.Request;
import com.lld.problems.B_Elevator.services.Elevator;
...
public class ElevatorController {
    ...
    private Elevator findOptimalElevator(int sourceFloor, int destinationFloor) {
        ...
        List<Elevator> optimalElevators = elevators.stream().anyMatch(e -> e.getCurrentDirection() == userDirection) ?
                elevators.stream().filter(e -> e.getCurrentDirection() == userDirection).toList() : elevators;
