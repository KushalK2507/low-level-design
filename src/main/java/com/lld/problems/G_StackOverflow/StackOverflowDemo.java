package com.lld.problems.G_StackOverflow;

import com.lld.problems.G_StackOverflow.entities.Answer;
import com.lld.problems.G_StackOverflow.entities.Question;
import com.lld.problems.G_StackOverflow.service.StackOverflow;
...
public class StackOverflowDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        questions.forEach(ques -> System.out.println(ques.getTitle()));
        ...
        questionsByUser.forEach(ques -> System.out.println(ques.getTitle()));
    }
}
