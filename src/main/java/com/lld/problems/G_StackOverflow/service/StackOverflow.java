package com.lld.problems.G_StackOverflow.service;

import com.lld.problems.G_StackOverflow.entities.*;
...
public class StackOverflow {
    ...
    public List<Question> searchQuestionByTag(String tagName) {
        ...
        questionTable.values().forEach(question -> {
            boolean isTagPresent = question.getTags().stream().anyMatch(tag -> tag.name().equals(tagName));
            if(isTagPresent) {
